...
function prepareIdxAndDocMap() {
  const docs = [  
    ...
    } ,    
    {
      ...
      "content": "Optimization There are some optimizations that Bellman performs to make queries run faster. Graph pushdown Join BGPs Compact BGPs Remove Nested Project"
    } ,    
    {
      "title": "Parser",
